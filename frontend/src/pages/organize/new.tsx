  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-semibold text-text-primary">Create Hackathon</h1>
      </div>
      ...
      <Card className="p-6">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Input label="Fee (₹)" type="number" min={0} error={errors.registrationFee?.message} {...register('registrationFee')} />
          ...
          <div className="flex justify-end gap-3 pt-2">
            <Button type="button" variant="ghost" onClick={() => navigate('/organize')}>Cancel</Button>
